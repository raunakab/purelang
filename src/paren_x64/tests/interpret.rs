...
fn interp_intermediary() {
    let program = source::ParenX64(source::P::begin(vec![
...
fn interp_by_setting_with_another_register() {
    let program = source::ParenX64(source::P::begin(vec![
        ...
        source::S::set_reg_triv {
            reg: cpsc411::Reg::rax,
            triv: source::Triv::trg(source::Trg::reg(cpsc411::Reg::rbx)),
        },
    ]));
...
fn interp_with_label() {
    let program = source::ParenX64(source::P::begin(vec![
        ...
        source::S::jump_trg(source::Trg::label(cpsc411::Label::halt_label())),
    ]));
...
fn interp_with_jumping_back_and_forth() {
    ...
    let program = source::ParenX64(source::P::begin(vec![
        source::S::jump_trg(source::Trg::label(jumper_label.clone())),
        source::S::with_label {
            label: label.clone(),
            s: Box::new(source::S::set_reg_triv {
                reg: cpsc411::Reg::rax,
                triv: source::Triv::int64(80),
            }),
        },
        source::S::set_reg_triv {
            reg: cpsc411::Reg::rax,
            triv: source::Triv::int64(70),
        },
        source::S::jump_trg(source::Trg::label(cpsc411::Label::halt_label())),
        source::S::with_label {
            label: jumper_label.clone(),
            s: Box::new(source::S::jump_trg(source::Trg::label(label.clone()))),
        },
    ]));
