...
impl ParenX64Rt {
    ...
    pub fn interp_loop(self) -> i64 {
        ...
        fn get_from_reg(reg: &cpsc411::Reg, reg_env: &RegEnv) -> i64 {
        ...
        fn bin_operate(
            ...
            match binop {
                cpsc411::Binop::plus => value1 + value2,
                cpsc411::Binop::multiply => value1 * value2,
            }
        }
        ...
        fn rel_operate(
            ...
            match relop {
                cpsc411::Relop::gt => value1 < value2,
                cpsc411::Relop::gte => value1 <= value2,
                cpsc411::Relop::lt => value1 > value2,
                cpsc411::Relop::lte => value1 >= value2,
                cpsc411::Relop::eq => value1 == value2,
                cpsc411::Relop::neq => value1 != value2,
            }
        }
