        ...
        fn select_tail(
            ...
            match tail {
                ...
                self::Tail::r#if { pred, tail1, tail2 } => {
                    ...
                    let tail1 =
                        make_begins!((effects1, tail1) => target::Tail::tail);
                    let tail2 =
                        make_begins!((effects2, tail2) => target::Tail::tail);
        ...
        fn select_pred(
            ...
            match pred {
                ...
                self::Pred::r#if {
                    ...
                    let pred2 =
                        make_begins!((effects2, pred2) => target::Pred::pred);
                    let pred3 =
                        make_begins!((effects3, pred3) => target::Pred::pred);
